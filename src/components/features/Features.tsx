...
const Features = () => {
  const features = [
    {
      title: "Utility Payments",
      description: "Easily pay electricity, water, and other utility bills in one place.",
      icon: "💡",
    },
    {
      title: "Recharge & Subscriptions",
      description: "Top up your airtime, buy data, and manage TV or streaming subscriptions with ease.",
      icon: "📱",
    },
    {
      title: "Exam Result Checker",
      description: "Quickly check your WAEC and NECO results without stress.",
      icon: "📄",
    },
  ];
