      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {dataPlans.map(plan => <Card key={plan.id} className={`${plan.popular ? 'border-primary-500 dark:border-primary-600 border-2' : ''}`}>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center mb-2">
                        <MapPinIcon size={14} className="text-secondary-500 mr-1" />
                      ...
                      <ul className="text-xs text-secondary-600 dark:text-secondary-400 mb-3">
                      ...
                      <div className="flex items-center justify-between mt-3">
                        <p className="text-lg font-medium text-primary-700 dark:text-primary-400">
                          {plan.price}
                        </p>
      ...
      <Card>
        ...
        <CardContent className="p-0">
          <div className="divide-y divide-secondary-200 dark:divide-secondary-800">
            {myEsims.map(esim => <div key={esim.id} className="p-4 hover:bg-secondary-50 dark:hover:bg-secondary-800/50 transition-colors">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between">
                  <div className="flex items-center mb-3 sm:mb-0">
                    <div className="w-10 h-10 rounded-full bg-primary-100 dark:bg-primary-900/30 flex items-center justify-center text-primary-700 dark:text-primary-400 mr-3">
                      <div size={18} />
                    </div>
                    <div>
