...
const VirtualNumber = () => {
    return (
        <div className="bg-gradient-to-r from-slate-500/50 via-slate-600 to-slate-700 text-white p-6 md:p-8 rounded-lg shadow-lg mb-6">
            ...
            <p className="text-sm md:text-lg">Generate your number for your virtual SIM for number verification.</p>
            <a href="https://www.tiktok.com/@_flozap/video/7549463248626650375?q=flozap&t=1761378169866" target="_blank" rel="noopener noreferrer">
