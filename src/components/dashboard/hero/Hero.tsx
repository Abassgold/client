...
const Hero = () => {
  return (
    <section>
      ...
      <div className="px-2 text-white py-8 md:text-2xl hero">
        <p className="max-w-[70rem] mx-auto">
          Step into the future with <span className="font-semibold text-xl text-justify md:text-3xl">FloZap</span>  — your all-in-one platform for crypto transactions, virtual numbers, utility bill payments, eSIM activation, airtime & data recharge, subscriptions, and gift card solutions. Fast, secure, and built for modern users who value convenience and control.
        </p>
      </div>
    </section>
  )
